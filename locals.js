...
I18N.zh = {
    ...
    "signup": { // 注册页
        "static": { // 静态翻译
            ...
            "By clicking “Create an account” below, you agree to our": "点击下面的“创建账户”，表示您同意我们的",
            "terms of service": "服务条款",
            "and": "和",
            "privacy statement": "隐私政策",
            ". We’ll occasionally send you account related emails.": "。我们偶尔会给您发送与帐户相关的电子邮件。",
            "Create an account": "创建账户",

            "Something went wrong": "填写内容不符合",
    ...
    "issues": { // 问题页面
        "static": { // 静态翻译
            ...
            "We couldn’t find any code matching": "找不到任何匹配的代码在",
            "No results matched your search.": "没有符合您的搜索结果。",
            "You could": "云 ",
            "search all of GitHub": "搜索所有Github",
